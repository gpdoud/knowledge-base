# The knowledge-base Repository (if there is an answer, it is here)
[Index](README.md)

- [C# commands](https://github.com/gpdoud/knowledge-base/blob/main/csharp.md)
- [Angular CLI Commands](https://github.com/gpdoud/knowledge-base/blob/main/angular-commands.md)
